...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container container-color">
            <a class="navbar-brand" href="#">
                <p style="font-weight: 700; font-size: 24px;"><img src="images/Logo.png" alt="logo" width="100"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="btn btn-outline-secondary shadow-sm d-sm d-block nav-link" href="login/login.php">Login</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-outline-secondary shadow-sm d-sm d-block nav-link" href="sign-up/sign-up.php">Sign up</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="caribbean-current-container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-6">
                <img src="images/gestao.png" alt="office" class="img-fluid">
            </div>
        </div>
    </div>
    ...
    <div class="container align-content-start">
        <div class="row">
            ...
            <div class="col-lg-6">
                <img src="images/gestao2.png" alt="office" class="img-fluid">
            </div>
        </div>
    </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow">
                    <div class="card-body text-center">
                        ...
                        <img src="images/Gabriel.png" alt="office" class="img-fluid team-member-image">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card border-0 shadow">
                    <div class="card-body text-center">
                        ...
                        <img src="images/carlos.jpg" alt="office" class="img-fluid team-member-image">
                    </div>
                </div>
            </div>
        </div>
