        ...
        <div class="row g-1 mb-2">
          <div class="col-md-12">
            <div class="input-group mb-3">
              ...
              <input type="password" class="form-control" name="senha_atual" maxlength="100" size="100"
        ...
        <div class="row g-2 mb-2">
          <div class="col-md-6">
            <div class="input-group mb-3">
              ...
              <input type="password" class="form-control" name="nova_senha" maxlength="100" size="100"
          ...
          <div class="col-md-6">
            <div class="input-group mb-3">
              ...
              <input type="password" class="form-control" name="confirmar_senha" maxlength="100" size="100"
